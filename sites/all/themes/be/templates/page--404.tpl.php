<?php
  ...
  if (theme_get_setting('notfound_bg')):
    $notfound_bg_fid = theme_get_setting('notfound_bg');
    $notfound_bg_img = file_create_url(file_load($notfound_bg_fid)->uri);
  endif;
?>

<div class="container-fluid<?php if ($page['sidebar']): ?> sidebar-present<?php else: ?> sidebar-absent<?php endif; ?> 404-page">
  ...
  <section class="jumbotron small">
    <div class="bg faded animated"<?php if (theme_get_setting('notfound_bg')): ?> style="background-image:url(<?php print $notfound_bg_img; ?>);"<?php endif; ?>></div>
